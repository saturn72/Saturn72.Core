...
namespace Saturn72.Core.Infrastructure
{
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <remarks>If you change this so that Nop assemblies arn'type investigated (e.g. by not including something like "^Nop|..." you may break core functionality.</remarks>
        ...
        public IEnumerable<Type> FindClassesOfType(Type assignTypeFrom, IEnumerable<Assembly> assemblies, bool onlyConcreteClasses = true)
        {
            Func<Type, IEnumerable<Type>> func = t =>
                {
                    return (assignTypeFrom.IsAssignableFrom(t) || (assignTypeFrom.IsGenericTypeDefinition && DoesTypeImplementOpenGeneric(t, assignTypeFrom))) ?
        ...
        private IEnumerable<Type> ReturnTypeEnumerableWhenOnlyConcreteClassesRequired(Type type, bool onlyConcreteClasses)
        {
        ...
        protected virtual IEnumerable<MethodInfo> SearchMethodsMatchesSearchCriteria(IEnumerable<Assembly> assemblies, Func<MethodInfo, bool> searchCriteria)
        {
            Func<Type, IEnumerable<MethodInfo>> func = t => t.GetMethods(BindingFlags.Public | BindingFlags.Instance).Where(searchCriteria);

            return SearchAssembliesBySearchCriteria(assemblies, func);

        }

        protected virtual IEnumerable<T> SearchAssembliesBySearchCriteria<T>(IEnumerable<Assembly> assemblies, Func<Type, IEnumerable<T>> func)
        {
            ...
            try
            {
                foreach (var a in assemblies)
                {
                    ...
                    if (types != null)
                        types.ForEachItem(t => result.AddRange(func(t)));
                }
            }
