...
namespace Automation.Core.Plugins
{
    public class PluginDescriptor : IComparable<PluginDescriptor>
    {
        ...
        public virtual T Instance<T>() where T : class, IInstallablePlugin
        {
            object instance;
        ...
        public IInstallablePlugin Instance()
        {
            return Instance<IInstallablePlugin>();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return other != null &&
                   ((SystemName == null && other.SystemName == null) ||
                   (SystemName != null && SystemName.Equals(other.SystemName)));
        }
